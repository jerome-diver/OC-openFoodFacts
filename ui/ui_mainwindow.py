...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.setStyleSheet("background-color: rgb(207, 234, 209);")
        ...
        self.users_box.setFont(font)
        self.users_box.setStyleSheet("background-color: qlineargradient(spread:reflect, x1:0.496, y1:0.494318, x2:0.975, y2:0.494318, stop:0.466102 rgba(243, 243, 243, 253), stop:0.707627 rgba(196, 192, 192, 255), stop:0.877119 rgba(117, 113, 113, 255), stop:1 rgba(74, 74, 74, 255));")
        self.users_box.setAlignment(QtCore.Qt.AlignCenter)
        ...
        self.user_informations = QtWidgets.QLabel(self.users_box)
        self.user_informations.setMaximumSize(QtCore.QSize(16777215, 20))
        font = QtGui.QFont()
        font.setFamily("Ubuntu")
        font.setPointSize(10)
        self.user_informations.setFont(font)
        self.user_informations.setStyleSheet("color: rgb(19, 45, 161);")
        self.user_informations.setText("")
        self.user_informations.setAlignment(QtCore.Qt.AlignCenter)
        self.user_informations.setObjectName("user_informations")
        self.verticalLayout.addWidget(self.user_informations)
...
"background-color: qlineargradient(spread:reflect, x1:0, y1:0, x2:1, y2:1, stop:0.0762712 rgba(243, 243, 243, 213), stop:0.423729 rgba(160, 160, 160, 212), stop:0.70339 rgba(84, 84, 84, 224), stop:1 rgba(37, 37, 37, 255));")
        ...
        self.substitute_mode_box.setStyleSheet("background-color: qlineargradient(spread:reflect, x1:0.496, y1:0.494318, x2:0.975, y2:0.494318, stop:0.466102 rgba(243, 243, 243, 253), stop:0.707627 rgba(196, 192, 192, 255), stop:0.877119 rgba(117, 113, 113, 255), stop:1 rgba(74, 74, 74, 255));")
        self.substitute_mode_box.setAlignment(QtCore.Qt.AlignCenter)
        ...
        self.verticalLayout_8.addLayout(self.horizontalLayout_user_mode)
        ...
        self.substitutes_list = QtWidgets.QTableView(self.frame_3)
        ...
        self.label.setStyleSheet("background-color: rgb(255, 102, 0);")
        ...
        self.label_2.setStyleSheet("background-color: rgb(255, 50, 0);")
        ...
        self.remove.setStyleSheet("background-color: qlineargradient(spread:pad, x1:1, y1:0, x2:0, y2:0.00568182, stop:0 rgba(255, 188, 151, 255), stop:0.55 rgba(235, 148, 61, 255), stop:0.98 rgba(30, 30, 30, 255), stop:1 rgba(0, 0, 0, 0));\n"
"color: rgb(200, 10, 26);")
        ...
        self.record.setStyleSheet("background-color: qlineargradient(spread:pad, x1:0, y1:0, x2:1, y2:0, stop:0 rgba(255, 188, 151, 255), stop:0.55 rgba(235, 148, 61, 255), stop:0.98 rgba(30, 30, 30, 255), stop:1 rgba(0, 0, 0, 0));\n"
"color: rgb(49, 94, 255);")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label.setText(_translate("MainWindow", "Pas de marque"))
        self.label_2.setText(_translate("MainWindow", "Pas de magasin"))
        ...
        self.remove.setText(_translate("MainWindow", "Supprimer de ma base"))
