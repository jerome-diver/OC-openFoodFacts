...
"background-color: qlineargradient(spread:reflect, x1:0, y1:0, x2:1, y2:1, stop:0.0762712 rgba(243, 243, 243, 213), stop:0.423729 rgba(160, 160, 160, 212), stop:0.70339 rgba(84, 84, 84, 224), stop:1 rgba(37, 37, 37, 255));")
        ...
        self.record.setStyleSheet("background-color: qlineargradient(spread:reflect, x1:0.496, y1:0.494318, x2:0.975, y2:0.494318, stop:0.29661 rgba(243, 107, 107, 103), stop:0.627119 rgba(201, 33, 33, 139), stop:0.860169 rgba(138, 91, 91, 235), stop:1 rgba(60, 60, 60, 255));\n"
"color: rgb(155, 155, 155);\n"
"selection-color: rgb(255, 255, 255);")
        self.record.setObjectName("record")
        self.verticalLayout_7.addWidget(self.record)
